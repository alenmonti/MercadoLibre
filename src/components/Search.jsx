...
const Search = ({searchFilter, setSearchFilter}) => {
    ...
    return (
        <div className="w-[90%] max-w-[580px] relative">
            <input onChange={(e) => setSearchFilter((prev) => prev + e.nativeEvent.data)} value={searchFilter} type="text" name="buscar" placeholder="Estoy buscando..." className="h-[40px]  w-full rounded-sm pl-3 shadow-md text-sm placeholder-opacity-40 placeholder-gray-500 outline-none"/>
